...
=head1 SYNOPSIS
 ...
 int OSSL_FUNC_decoder_get_params_fn(OSSL_PARAM params[]);

 /* Functions to construct / destruct / manipulate the decoder context */
 void *OSSL_FUNC_decoder_newctx_fn(void *provctx);
 void OSSL_FUNC_decoder_freectx_fn(void *ctx);
 ...
 int OSSL_FUNC_decoder_decode_fn(void *ctx, OSSL_CORE_BIO *in,
                              int selection,
                              OSSL_CALLBACK *data_cb, void *data_cbarg,
                              OSSL_PASSPHRASE_CALLBACK *cb, void *cbarg);

 /* Functions to export a decoded object */
 int OSSL_FUNC_decoder_export_object_fn(void *ctx,
